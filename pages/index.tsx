...
const Card = tw.a`
  ...
  border border-solid border-zinc-200 max-w-[300px] rounded-2xl
  hover:(text-blue-600 border-blue-600)
  focus:(text-blue-600 border-blue-600)
  ...
  return (
    <div tw="px-8">
      ...
      <main tw="py-16 flex flex-1 flex-col items-center justify-center min-h-screen">
        <h1 tw="m-0 text-6xl font-extrabold">Welcome to VL Republics</h1>

        <p tw="my-16 text-2xl">
          Get started by editing{' '}
          <code tw="bg-zinc-100 dark:bg-zinc-900 rounded text-[1.1rem] p-3 font-mono">pages/index.tsx</code>
        </p>
